...
#define CLOCK_SOURCE                                                          USE_PLL_HSE_EXTC|USE_PLL_HSI                                                                     // set by target:NUCLEO_F413ZH
#define LPTICKER_DELAY_TICKS                                                  4                                                                                                // set by target:NUCLEO_F413ZH
...
#define MBED_CONF_TARGET_LPTICKER_LPTIM                                       1                                                                                                // set by target:NUCLEO_F413ZH
...
#define MBED_CONF_TARGET_TICKLESS_FROM_US_TICKER                              1                                                                                                // set by target:NUCLEO_F413ZH
