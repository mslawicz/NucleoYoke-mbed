...
SPI ledRGB(PB_15, NC, PB_13);    //XXX 1-wire with no MISO signal
DigitalOut testSignal(PC_8);        //XXX
DigitalOut test2(PC_9);         //XXX
...
uint8_t dataBuffer[] = {0x88,0x88,0x88,0x88,  0x88,0x88,0xE8,0x88,  0x88,0x88,0x88,0x88,  0x88,0x88,0x88,0x88,  0x88,0x88,0x88,0x88,  0x88,0x88,0xE8,0x88,
        0x88,0x88,0x8E,0x88,  0x88,0x88,0x88,0x88,  0x88,0x88,0x8E,0x88,  0x88,0x88,0x88,0x88,  0x88,0x88,0x8E,0x88,  0x88,0x88,0x8E,0x88,
...
void myCallback(int x) { test2 = !test2; } //XXX
...
int main()
{
    ...
    ledRGB.frequency(4000000);  // XXX
    ledRGB.format(8, 1);
    functionPointer.attach(myCallback);
    ...
    while (true)
    {
        ...
        // XXX SPI test
        testSignal = 1;
        ledRGB.transfer<uint8_t>(dataBuffer, sizeof(dataBuffer), NULL, 0, functionPointer);
