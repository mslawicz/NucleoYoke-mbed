...
/*
 * 9DOF algorithm update
 */
void MadgwickFilter::update9DOF(float gx, float gy, float gz, float ax,
        float ay, float az, float mx, float my, float mz, float dt)
{
    float recipNorm;
    float s0, s1, s2, s3;
    ...
    float _2q0mx, _2q0my, _2q0mz, _2q1mx, _2bx, _2bz, _4bx, _4bz, _8bx, _8bz,
            _2q0, _2q1, _2q2, _2q3, _2q0q2, _2q2q3, q0q0, q0q1, q0q2, q0q3,
    ...
    if (!((ax == 0.0f) && (ay == 0.0f) && (az == 0.0f)))
    {
        ...
        s0 = -_2q2 * (2.0f * (q1q3 - q0q2) - ax)
                ...
                + -_4bz * q2
                        * (_4bx * (0.5 - q2q2 - q3q3) + _4bz * (q1q3 - q0q2)
                                - mx)
                + (-_4bx * q3 + _4bz * q1)
                        * (_4bx * (q1q2 - q0q3) + _4bz * (q0q1 + q2q3) - my)
                + _4bx * q2
                        * (_4bx * (q0q2 + q1q3) + _4bz * (0.5 - q1q1 - q2q2)
                                - mz);
...
/*
 * 6DOF algorithm update
 */
void MadgwickFilter::update6DOF(float gx, float gy, float gz, float ax,
